    ...
    <div className="mt-auth-wrapper">
      ...
      <div className="mt-auth-left">
        <div className="mt-auth-form-box">
          ...
          <h1 className="mt-auth-title">¡Bienvenido<br />de vuelta!</h1>
          <p className="mt-auth-subtitle" style={{ display: 'none' }}>Ingresa tus credenciales para acceder a tu cuenta.</p>
          ...
          {/* Social login */}
          <div className="mt-social-logins">
            <button type="button" className="mt-social-circle-btn" onClick={() => triggerGoogleLogin()} disabled={loading} aria-label="Sign in with Google">
              <svg className="mt-google-icon-circle" viewBox="0 0 24 24">
